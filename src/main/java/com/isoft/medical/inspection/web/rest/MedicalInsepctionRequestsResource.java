...
public class MedicalInsepctionRequestsResource {
    ...
    public ResponseEntity<List<MedicalInsepctionRequestsDTO>> getAllMedicalInsepctionRequests(Pageable pageable) {
        log.debug("REST request to get a page of MedicalInsepctionRequests");
        Page<MedicalInsepctionRequestsDTO> page = medicalInsepctionRequestsService.findAll(pageable);

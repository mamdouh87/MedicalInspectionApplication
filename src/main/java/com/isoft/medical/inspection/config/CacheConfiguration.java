...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.isoft.medical.inspection.domain.MedicalInsepctionRequests.class.getName() + ".medicalInsepctionRequests");
            createCache(cm, com.isoft.medical.inspection.domain.RequestBiometricData.class.getName());
            createCache(cm, com.isoft.medical.inspection.domain.RequestInseptionDetails.class.getName());
